        ...
        ->assertJson([
            'data' => [
                ...
                'relationships' => [
                    'authors' => [
                        'links' => [
                            'self' => route('books.relationships.authors', ['id' => $book->id]),
                            'related' => route('books.authors', ['id' => $book->id]),
                        ],
                        'data' => [
                            [
                                'id' => $authors->get(0)->id,
            ...
            "data" => [
                    ...
                    'relationships' => [
                        'authors' => [
                            'links' => [
                                ...
                                'related' => route('books.authors', ['id' => $books[0]->id]),
                            ],
                            'data' => [
                                [
                                    'id' => $authors->get(0)->id,
                    ...
                    'relationships' => [
                        'authors' => [
                            'links' => [
                                ...
                                'related' => route('books.authors', ['id' => $books[1]->id]),
                            ],
                        ]
                    ]
                ],
                [
                    ...
                    'relationships' => [
                        'authors' => [
                            'links' => [
                                'self' => route('books.relationships.authors', ['id' => $books[2]->id]),
                                'related' => route('books.authors', ['id' => $books[2]->id]),
                            ],
                        ]
                    ]
                ],
