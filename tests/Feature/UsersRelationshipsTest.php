        ...
        ->assertJson([
            "data" => [
                ...
                'relationships' => [
                    'comments' => [
                        'links' => [
                            'self' => route('users.relationships.comments', ['id' => $user->id]),
                            'related' => route('users.comments', ['id' => $user->id]),
                        ],
                        'data' => [
                            [
            ...
            "data" => [
                [
                    ...
                    'relationships' => [
                        'comments' => [
                            'links' => [
                                'self' => route('users.relationships.comments', ['id' => $users->first()->id]),
                                'related' => route('users.comments', ['id' => $users->first()->id]),
                            ],
                            'data' => [
                                [
                                    'id' => $comments->get(0)->id,
